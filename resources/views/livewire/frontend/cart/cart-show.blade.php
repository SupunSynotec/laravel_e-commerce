        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="shopping-cart">
                        ...
                        @forelse ($cart as $cartItem)
                            @if ($cartItem->product)
                                {{-- {{ dd($cartItem->productColor) }}  --}}
                                <div class="cart-item">
                                    <div class="row">
                                        <div class="col-md-6 my-auto">
                                            <a
                                                href="{{ url('collecton/' . $cartItem->product->category->slug . '/' . $cartItem->product->slug) }}">
                                                    ...
                                                    @if ($cartItem->productColor)
                                                        @if ($cartItem->productColor->color)
                                                            - Color: <label for="" class="colorSelectionSpan"
                                                                style="background-color: {{ $cartItem->productColor->color->code }}">{{ $cartItem->productColor->color->name }}</label>
                                                        @endif
                                                    @endif
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>Get the best deals & offers <a href="{{ url('/collecton') }}">shop now</a></h5>
                </div>
